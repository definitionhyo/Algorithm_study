...
//		****************************
//		number_2738이랑 다르게 오류가 발생하는 이유
//		
//		number_2566은 배열 크기가 고정되어 있어 토큰화한 입력값이 배열 크기를 벗어나면 오류가 발생할 수 있어 실행되지 않았고 
//		number_2738은 동적 배열을 사용하여 입력값의 개수에 상관없이 오류가 발생하지 않음.
//		****************************
...
//		** StringTokenizer st = new StringTokenizer(br.readLine()); 오류
...
//			st = new StringTokenizer(br.readLine());
			StringTokenizer st = new StringTokenizer(br.readLine()); // 오류해결
			for(int j = 0; j < 9; j++) {
